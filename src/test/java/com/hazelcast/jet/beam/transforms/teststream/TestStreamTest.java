...
/* "Inspired" by org.apache.beam.sdk.testing.TestStreamTest */
public class TestStreamTest extends AbstractTransformTest {
    ...
    public void testLateDataAccumulating() {
        ...
        PCollection<Integer> triggered = windowed
                        .apply(WithKeys.of(1))
                ...
                .satisfies(
                        input -> {
                            for (Long count1 : input) {
                                MatcherAssert.assertThat(count1, allOf(greaterThanOrEqualTo(3L), lessThanOrEqualTo(5L)));
                            }
                            return null;
                        });
        PAssert.that(sum)
                ...
                .satisfies(
                        input -> {
                            for (Integer sum1 : input) {
                                MatcherAssert.assertThat(sum1, allOf(greaterThanOrEqualTo(6), lessThanOrEqualTo(15)));
                            }
                            return null;
                        });
    ...
    @Test
    @Ignore // advancing processing time not supported in TestStream
    ...
    public void testMultipleStreams() {
        ...
        PCollection<String> createStrings =
                pipeline.apply("CreateStrings", stream)
                        .apply(
                                "WindowStrings",
        ...
        PCollection<Integer> createInts =
                pipeline.apply("CreateInts", other)
                        .apply(
                                "WindowInts",
    ...
    @Test
    @Ignore // processing time triggers not supported
